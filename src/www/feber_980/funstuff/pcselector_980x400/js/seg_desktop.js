...
Util.Objects["hwundpcsel980x400"] = new function() {
	this.init = function(banner) {
		...
		for(i = 0; i <= 205; i++) {
			banner._images.push("/feber_980/funstuff/pcselector_980x400/img/sequence/PcSelector_980x400_0" + ((i > 9 ? i > 99 ? "0" : "00" : "000") + i) + ".jpg");
		}
