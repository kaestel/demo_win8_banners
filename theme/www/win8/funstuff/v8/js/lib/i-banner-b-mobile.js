Util.Objects["hwundwinb_mobile"] = new function() {
	this.init = function(banner) {
		...
		// }
		// if(u.qs(".audioplayer", banner)) {
		// 	banner.removeChild(u.qs(".audioplayer", banner));
		// }
		// if(u.qs(".easter_1", banner)) {
		// 	banner.removeChild(u.qs(".easter_1", banner));
		// }
		// if(u.qs(".easter_2", banner)) {
		// 	banner.removeChild(u.qs(".easter_2", banner));
		// }
		// if(u.qs(".mute", banner)) {
		// 	banner.removeChild(u.qs(".mute", banner));
		// }
